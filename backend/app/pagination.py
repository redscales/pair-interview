...
The cursor on the wire is opaque: a base64url-encoded JSON object that
encodes the id of the last visible row of the previous page. Clients
should treat the cursor as a black box and round-trip it unmodified.
"""
